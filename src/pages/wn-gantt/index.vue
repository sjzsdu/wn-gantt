  ...
  methods: {
    ...
    handleRowClick(row, column, event) {
      /* if (this.useCheckColumn && this.quickCheck) {
        ...
        this.$refs["wn-gantt"].toggleRowSelection(row, !is_check);
        this.$nextTick(() => {
    ...
    loadTreeAdd(id, list) {
      let _children =
        this.$refs["wn-gantt"].store.states.lazyTreeNodeMap[id] || [];
      this.$set(
        this.$refs["wn-gantt"].store.states.lazyTreeNodeMap,
        id,
    ...
    loadTreeRemove(id, key) {
      let _children = this.$refs["wn-gantt"].store.states.lazyTreeNodeMap[id];
